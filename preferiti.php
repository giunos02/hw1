  ...
  ?>
    ...
    <body>
      ...
      <div id="menu">
        ...
        <a class = "sottotitolo">In questa sezione puoi cercare le canzoni preferite dagli utenti iscritti al nostro blog.</a>
        </header>
        ...
        <form id="search-form" autocomplete="off">
            <div class="search">
                ...
                <input type='text' name="search" class="searchBar" value="Scrivi il nome dell'utente...">
